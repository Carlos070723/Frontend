        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <!-- Perfil con usuario activo y logout -->
                    <button type="button" class="layout-topbar-action" (click)="toggleProfile()">
                        <i class="pi pi-user"></i>
                        <span>{{ currentUser?.nombre_usuario || 'Profile' }}</span>
                    </button>
...
export class AppTopbar {
    items!: MenuItem[];
    currentUser: { id_usuario: number; nombre_usuario: string; nivel: string } | null = null;
